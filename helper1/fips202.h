...
// These are kept for compatibility (older PQClean style)
#define PQC_SHAKECTX_BYTES     200  // 25*8
#define PQC_SHAKEINCCTX_BYTES  208  // 26*8 (25 state + 1 bytecount)
